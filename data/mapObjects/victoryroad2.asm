VictoryRoad2Object:
	...
	db 13 ; objects
	object SPRITE_HIKER, 12, 9, STAY, LEFT, 1, Blackbelt, 9
	object SPRITE_BLACK_HAIR_BOY_2, 21, 13, STAY, LEFT, 2, Juggler, 2
	object SPRITE_BLACK_HAIR_BOY_1, 19, 8, STAY, DOWN, 3, Tamer, 5
	object SPRITE_BLACK_HAIR_BOY_2, 4, 2, STAY, DOWN, 4, PokeManiac, 6
	object SPRITE_BLACK_HAIR_BOY_2, 26, 3, STAY, LEFT, 5, Juggler, 5
