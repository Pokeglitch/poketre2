ViridianForestObject:
	...
	object SPRITE_BUG_CATCHER, 30, 33, STAY, LEFT, 2, BugCatcher, 1
	object SPRITE_BUG_CATCHER, 30, 19, STAY, LEFT, 3, BugCatcher, 2
	object SPRITE_BUG_CATCHER, 2, 18, STAY, LEFT, 4, BugCatcher, 3
