RocketHideout1Object:
	...
	db 7 ; objects
	object SPRITE_ROCKET, 26, 8, STAY, LEFT, 1, Rocket, 8
	object SPRITE_ROCKET, 12, 6, STAY, RIGHT, 2, Rocket, 9
	object SPRITE_ROCKET, 18, 17, STAY, DOWN, 3, Rocket, 10
	object SPRITE_ROCKET, 15, 25, STAY, RIGHT, 4, Rocket, 11
	object SPRITE_ROCKET, 28, 18, STAY, LEFT, 5, Rocket, 12
