Route8Object:
	...
	db 9 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, 8, 5, STAY, RIGHT, 1, SuperNerd, 3
	object SPRITE_GAMBLER, 13, 9, STAY, UP, 2, Gambler, 5
	object SPRITE_BLACK_HAIR_BOY_2, 42, 6, STAY, UP, 3, SuperNerd, 4
	object SPRITE_LASS, 26, 3, STAY, LEFT, 4, Lass, 13
	object SPRITE_BLACK_HAIR_BOY_2, 26, 4, STAY, RIGHT, 5, SuperNerd, 5
