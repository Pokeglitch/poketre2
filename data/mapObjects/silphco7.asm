SilphCo7Object:
	...
	object SPRITE_ROCKET, 13, 1, STAY, DOWN, 5, Rocket, 32
	object SPRITE_OAK_AIDE, 2, 13, STAY, DOWN, 6, Scientist, 8
	object SPRITE_ROCKET, 20, 2, STAY, LEFT, 7, Rocket, 33
	object SPRITE_ROCKET, 19, 14, STAY, RIGHT, 8, Rocket, 34
